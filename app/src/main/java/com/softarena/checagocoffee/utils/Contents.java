...
public final class Contents {
    ...
    public static final class Type {
        ...
        public static final String SCAN = "SCAN_TYPE";
        ...
        public static final String BOOK = "BOOK_TYPE";

        public static final String CALENDER = "CALENDER_TYPE";

        public static final String WIFI = "WIFI_TYPE";

        public static final String PRODUCT = "PRODUCT_TYPE";

        public static final String ADDRESS = "ADDRESS_TYPE";
